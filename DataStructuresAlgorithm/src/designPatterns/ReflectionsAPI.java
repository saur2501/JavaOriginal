...
class UFOEnemyShip1 extends EnemyShip {
	...
	public UFOEnemyShip1(int number, String randString) {
...
public class ReflectionsAPI {
	public static void main(String[] args) {
		// Getting the class Object for UFOEnemyShip1
		// Everything in Java has a Class Object
		Class reflectClass = UFOEnemyShip1.class;
		...
		// Get the super class for UFOEnemyShip1
		...
		UFOEnemyShip1 newEnemyShip = null;
		EnemyShipFactory shipFactory = null;
		try {
			// Create a UFOEnemyShip1 object by calling newInstance
			newEnemyShip = (UFOEnemyShip1) constructor.newInstance(shipFactory);
		} catch (InstantiationException | IllegalAccessException | IllegalArgumentException
				| InvocationTargetException e) {
			e.printStackTrace();
		}
		// Now I can call methods in the UFOEnemyShip1 Object
		...
		try {
			// Create a UFOEnemyShip1 object
			UFOEnemyShip1 enemyshipPrivate = new UFOEnemyShip1(shipFactory);
			// Define the private field you want to access
			// I can access any field with just its name dynamically
			privateStringName = UFOEnemyShip1.class.getDeclaredField("idCode");
			...
			Method privateMethod = UFOEnemyShip1.class.getDeclaredMethod(methodName, null);
			...
			// parameters
			privateMethod = UFOEnemyShip1.class.getDeclaredMethod("getOtherPrivate", methodParameters);
			// Shuts down security allowing you to access private methods
			privateMethod.setAccessible(true);

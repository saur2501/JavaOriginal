...
//Here we define a basic component of a space ship. Any part that implements the interface ESEngine an replace that part in any ship
...
class ESUFOEngine implements ESEngine{
	...
	// The Strategy design pattern is being used here. When the field that is of type ESUFOGun is printed the following shows on the screen

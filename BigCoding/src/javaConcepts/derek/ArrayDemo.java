...
public class ArrayDemo {
...

    {
        ...
        ArrayMonster[] Monsters = new ArrayMonster[4];

         

        // ArrayMonster(int health, int attack, int movement, String name)

         

        Monsters[0] = new ArrayMonster(1000, 20, 1, "Frank");

        Monsters[1] = new ArrayMonster(500, 40, 2, "Drac");

        Monsters[2] = new ArrayMonster(1000, 20, 1, "Paul");

        Monsters[3] = new ArrayMonster(1000, 20, 1, "George");

         

        ArrayMonster.redrawBoard();

         

     

    for (ArrayMonster m : Monsters)
...
class ArrayMonster{
    static char[][] battleBoard = new char[10][10];				//	Creates a multidimensional array of chars
    public static void buildBattleBoard(){						// This static method builds an empty battle board
        for(char[] row : battleBoard)							        // Cycles through the array and gives a default value of * to everything
            Arrays.fill(row, '*');
    }
    ...
    public void moveMonster(ArrayMonster[] monster, int arrayItemIndex)
    ...
    public boolean onMySpace(ArrayMonster[] monster, int indexToChk1, int indexToChk2)
    ...
    public ArrayMonster(int health, int attack, int movement, String name)

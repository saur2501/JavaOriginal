...
public class Lesson28 extends JFrame {
	...
	public Lesson28() {
		...
		/*
		 * FLOW LAYOUT // Create a flow layout (Default) JPanel thePanel = new
		 * JPanel();
		 * 
		 * // Define the flow layout alignment // FlowLayout.RIGHT,
		 * FlowLayout.CENTER
		 * 
		 ...
		 * 
		 * button1 = new JButton("Button 1"); thePanel.add(button1);
		 * 
		 * END FLOW LAYOUT
		 */
		...
		/*
		 * 
		 * thePanel.add(button1, BorderLayout.NORTH); thePanel.add(button2,
		 * BorderLayout.SOUTH); thePanel.add(button3, BorderLayout.EAST);
		 * thePanel.add(button4, BorderLayout.WEST); thePanel.add(button5,
		 * BorderLayout.CENTER);
		 */

		/*
		 * If you want more than one component to show // up in the same part of
		 * a border layout put // them in a panel and then add the panel to //
		 * the border layout panel
		 * 
		 * 
		 * JPanel thePanel2 = new JPanel();
		 * 
		 * thePanel2.add(button1); thePanel2.add(button2);
		 * 
		...
		/*
		 * theBox.add(button1); theBox.add(button2); theBox.add(button3);
		 * theBox.add(button4);
		 */
		 ...
		 * theBox.add(button3); theBox.add(Box.createHorizontalStrut(4));
		 * theBox.add(button4);
		 */

...
public class Lesson36 {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * "((b.H+b.BB)+(2.4*(b.AB+b.BB)))*(t.TB+(3*(b.AB+b.BB)))/(9*(b.AB+b.BB))-(.9*(b.AB+b.BB)) AS TTRC, "
			 * + "b.teamID AS Team, 0 AS Salary, " + "0 AS CPR, f.POS AS POS " +
			 ...
			 * int numOfCol;
			 * 
			 * // Retrieves the number, types and properties of the Query
			 * Results
			 * 
			 ...
			 * 
			 * columns[i] = metaData.getColumnName(i); System.out.println(i); }
			 */
		 ...
		 *
		 * TableColumn tc = table.getColumn("TTRC"); RightTableCellRenderer
		 * rightRenderer = new RightTableCellRenderer();

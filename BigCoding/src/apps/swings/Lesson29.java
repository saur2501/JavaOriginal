...
public class Lesson29 extends JFrame {
	...
	private static final long serialVersionUID = -1108891493026257566L;
	...
	public Lesson29() {
		...
		/*
		 * thePanel.add(but1); thePanel.add(but2); thePanel.add(but3);
		 * thePanel.add(but4); thePanel.add(but5); thePanel.add(but6);
		 * thePanel.add(but7); thePanel.add(but8); thePanel.add(but9);
		 * thePanel.add(butPlus); thePanel.add(but0); thePanel.add(butMinus);
		 */

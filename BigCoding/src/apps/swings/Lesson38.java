	...
	public static void main(String[] args) {
		...
		try {
			...
			while (rows.next()) {
				...
				/*
				 * You can also get other types int getInt() boolean
				 * getBoolean() double getDouble() float getFloat() long
				 * getLong() short getShort()
				 */
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseReleased(MouseEvent me) {
				...
				try {
					...
					// If you get an error here it is because you aren't using
					// Java 1.7
...
/*
 * ALTER TABLE president ADD COLUMN pres_id INT AUTO_INCREMENT NOT NULL FIRST,
